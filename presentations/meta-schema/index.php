...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Meta and Schema: Defining the Content about your Content | Web Development Presentation</title>
    <meta name="description" content="This session reviews implementing Schema.org schemas for structured data and current best practice meta tags in Drupal and WordPress."/>
    <link rel="canonical" href="https://jimbir.ch/presentations/meta-schema/"/>
    <!-- Open Graph. -->
    <meta property="og:site_name" content="Jim Birch"/>
    <meta property="og:type" content="public_figure"/>
    <meta property="og:url" content="https://jimbir.ch/presentations/meta-schema/"/>
    <meta property="og:title" content="Meta and Schema: Defining the Content about your Content | Web Development Presentation"/>
    <meta property="og:description" content="This session reviews implementing Schema.org schemas for structured data and current best practice meta tags in Drupal and WordPress."/>
    <meta property="og:image" content="https://jimbir.ch/sites/default/files/img/presentations/presentation-meta-schema-1200.jpg"/>
    ...
    <meta name="twitter:url" content="https://jimbir.ch/presentations/meta-schema/"/>
    <meta name="twitter:title" content="Meta and Schema: Defining the Content about your Content | Web Development Presentation"/>
    <meta name="twitter:description" content="This session reviews implementing Schema.org schemas for structured data and current best practice meta tags in Drupal and WordPress."/>
    <meta name="twitter:image:src" content="https://jimbir.ch/sites/default/files/img/presentations/presentation-meta-schema-1200.jpg"/>

    <!-- Standard Meta. -->
    <meta itemprop="name" content="Meta and Schema: Defining the Content about your Content | Web Development Presentation"/>
    <meta itemprop="description" content="This session reviews implementing Schema.org schemas for structured data and current best practice meta tags in Drupal and WordPress."/>
    <meta itemprop="image" content="https://jimbir.ch/sites/default/files/img/presentations/presentation-meta-schema-1200.jpg"/>
  ...
  <body>
    <div class="reveal">
      <div class="fixed-footer">
        <div class="fixed-footer__first"><a href="https://jimbir.ch/presentations/meta-schema/">jimbir.ch/meta-schema</a> <a href="https://www.twitter.com/thejimbirch" title="@thejimbirch">@thejimbirch</a> <a href="https://twitter.com/search?q=%23wcpub">#wcpub</a></div>
      ...
      <div class="slides">
        <section style="text-align:left;" data-background="img/Lego-Uncle-Jim-in-Iceland.jpg" data-transition="zoom">
          ...
          <div style="color:#fff;display:inline-block;background: rgba(0, 0, 0, 0.7);padding-left:20px;width:70%">
            <img src="img/kanopi-logo.png" alt="Kanopi Studios" style="background: #fff; float: left; width: 130px; padding: 60px 20px;height: auto;"><br>
            <div class="box" style="float: left;padding-left:20px;padding-bottom:20px;margin-top:-30px">
              ...
              <a href="https://jimbir.ch/presentations/meta-schema/">jimbir.ch/meta-schema</a>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <p><code>
            ...
            <span class="fragment">content="This session reviews implementing Schema.org schemas for structured data and current best practice meta tags in Drupal and WordPress."></span>
            </code>
          </p>
        </section>
        ...
        <section style="text-align: left;" data-background="img/Lego-Uncle-Jim-in-Greece-by-the-cactus-by-the-sea.jpg" data-background-position="center bottom" data-transition="zoom">
